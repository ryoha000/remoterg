...
use windows::Win32::Media::MediaFoundation::{
    ...
    MFVideoFormat_H264, MFVideoFormat_NV12, MFVideoInterlace_Progressive, MFT_SET_TYPE_TEST_ONLY,
...
/// メディアタイプを設定
pub fn setup_media_types(transform: &IMFTransform, width: u32, height: u32) -> Result<()> {
    unsafe {
