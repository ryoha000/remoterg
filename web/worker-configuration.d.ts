/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a9429007f90f9f63c025174027f92e72)
// Runtime types generated with workerd@1.20251202.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "SignalingSession";
	}
	interface Env {
		...
		SIGNALING_SESSION: DurableObjectNamespace<import("./src/worker").SignalingSession>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_SENTRY_DSN" | "VITE_SENTRY_ORG" | "VITE_SENTRY_PROJECT" | "SENTRY_AUTH_TOKEN" | "ANTHROPIC_API_KEY">> {}
}
